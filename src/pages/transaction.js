...
export default function Checkout() {
    ...
    return ( <
        ...
        className = "items-start px-20 rounded-md py-2 max-w-fit bg-gray-900 text-white hover:scale-105 mt-3" > ⬅️ & nbsp; & nbsp; Go back to your dashboard <
        /button>
        ...
        <
        h1 > Please scan the QR code below with your Solana wallet
        if you want to send < span className = "font-bold" > $ { amount.toString() } < /span> to  <
        span className = "font-bold pl-1" > { router.query.address } < /span></h
        1 >
        <
